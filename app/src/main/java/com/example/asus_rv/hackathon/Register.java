        ...
        public void call(final Object... args){
            runOnUiThread(new Runnable() {
                ...
                public void run()
                {
                    ...
                    {
                        Toast.makeText(Register.this, "welcome Persona", Toast.LENGTH_SHORT).show();
                        Intent OpenMyHome=new Intent(Register.this,Home.class);
                        startActivity(OpenMyHome);
                    }
                    else if (msg.Respuesta.equals("Fijo"))
                    {
                        Toast.makeText(Register.this, "Welcome Fijo", Toast.LENGTH_SHORT).show();
                        Intent OpenMyHome2=new Intent(Register.this,Home.class);
                        startActivity(OpenMyHome2);
                    }
                    else
                    {
                        Toast.makeText(Register.this, "No se encontro la cuentaad", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
